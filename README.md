...
1. [`ddi-workshop`](https://github.com/ataudte/ddi-workshop) establishes the current state, business outcomes, target operating model, target architecture and data authority model.
2. [`ddi-questionnaire`](https://github.com/ataudte/ddi-questionnaire) evaluates candidate solutions, validates critical workflows and records accepted conditions.
3. **`ddi-migration-plan`** executes the approved design and selected solution through controlled migration waves.

### Minimum Input From [`ddi-questionnaire`](https://github.com/ataudte/ddi-questionnaire)
...
### Supporting Input From [`ddi-workshop`](https://github.com/ataudte/ddi-workshop)
